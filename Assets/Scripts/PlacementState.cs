...
public class PlacementState : IBuildingState
{
    ...
    public void OnAction(Vector3Int gridPosition)
    {
        ...
        BuildTypes buildType = database.objectsData[selectedObjectIndex].thisBuildType;
    ...
    private bool CheckPlacementValidity(Vector3Int gridPosition, int selectedObjectIndex)
    {
        ...
        {
            // If the position is  occupied, we cannot place the object
            return false;
        }
        ...
        {
           //Collider tagleri istediğin kadar ekleyebilirsin
            if (collider.CompareTag("Obstacle") || collider.CompareTag("Building") || collider.CompareTag("Player") || collider.CompareTag("Enemy") || collider.CompareTag("Resource"))
            {
                // If there is a collider on the position, we cannot place the object
                return false;
            }
        }
